...
<section class="inner-part">
	...
	<div class="row color">
		<div class="col">
			...
			<div class="row">
				<div class="col-sm-12">
					<h3  class="pb-2"> Blog Categories</h3>
		                            ...
		                            <tbody>
		                            	...
		                            	@foreach($records as $rec)
		                            		<tr>
												...
												<td>
												<a href="{{ url('rt-admin/blog-category/'.$rec->category_id) }}" title="Edit" class="text-success">
				                                        	<i class="icon-pencil"></i>
				                                        </a>&nbsp;		
												<a href="{{ url('rt-admin/blog-category?status='.$rec->category_is_visible.'&id='.$rec->category_id) }}" class="{{ $rec->category_is_visible == 'Y' ? 'text-success': 'text-danger' }}">
