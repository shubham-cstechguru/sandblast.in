							...
							<?php endif; ?>
                                ...
                                <div class="content-part">
            						<div class="category">
            							<div class="form-group">
            								...
            								<textarea rows="10" name="record[top_content]" placeholder="Description" class="form-control editor"><?php echo e(@$edit->top_content); ?></textarea>
            							</div>
            						</div>
            					</div>
            					<div class="content-part">
            						<div class="category">
            							<div class="form-group">
            								...
            								<textarea rows="10" name="record[bottom_content]" placeholder="Description" class="form-control editor"><?php echo e(@$edit->bottom_content); ?></textarea>
            							</div>
            						</div>
            					</div>
								<div class="category mt-3">
									...
									<div class="form-group" style="margin-top:10px">
										...
										<input type="text" name="record[seo_title]" value="<?php echo e(@$edit->seo_title); ?>" placeholder="Seo title" class="form-control">
									</div>
									<div class="form-group">
										<label>Seo keywords </label>
										<textarea rows="3" name="record[seo_keyword]" class="form-control" plcaehlder="Seo keywords"><?php echo e(@$edit->seo_keyword); ?></textarea>
									</div>
									<div class="form-group">
                                        <label for="seo_description">Seo Description</label>
                                        <textarea class="form-control" id="seo_description" rows="3" name="record[seo_description]" placeholder="Seo description..."><?php echo e(@$edit->seo_description); ?></textarea>
                                  </div>
							</form>
...
<?php /**PATH /home4/abrasivegarnet/sandblast.in/resources/views/backend/inc/category.blade.php ENDPATH**/ ?>