...
<header>
  <div class="header-top" id="jp_header">
        <div class="container">
            ...
            <div class="col-sm-9 col-8 text-right" style="justify-content: flex-end;align-items: center;display: flex;">
...
<?php /**PATH /home4/abrasivegarnet/sandblast.in/resources/views/frontend/common/header.blade.php ENDPATH**/ ?>