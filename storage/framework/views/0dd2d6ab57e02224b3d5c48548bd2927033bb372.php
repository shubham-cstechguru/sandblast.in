...
<footer class="bg-dark py-4">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-5">
                <div class="footer-img">
                    ...
                    <img src="<?php echo e(url('imgs/'. $title[0]->setting_logo)); ?>" alt="">
                    <?php endif; ?>
                </div>
                <div class="footer-content">
                    <p><?php echo e(@$title[0]->setting_desc); ?></p>
                </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-3 footer-list">
                ...
                <!-- <ul class="list-unstyled" style="line-height: 32px;">
                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="city/<?php echo e($c['city_slug']); ?>"><i class="icon-location mr-2" aria-hidden="true"></i><?php echo e($c['city_name']); ?></a></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul> -->
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4 footer-list">
                <?php if($title[0]->setting_mobile != '' || $title[0]->setting_whatsapp != '' || $title[0]->setting_contact_email != ''): ?>
                <h1 class="text-left lead"><b>Contact Us</b></h1>
                <?php endif; ?>
                <ul class="list-unstyled" style="line-height: 32px;">
                    <?php if($title[0]->setting_mobile != ''): ?>
                    <li><a href="tel:+91<?php echo e(@$title[0]->setting_mobile); ?>"><i class="icon-phone mr-2" aria-hidden="true"></i>+91 <?php echo e(@$title[0]->setting_mobile); ?></a></li>
                    <?php endif; ?>
                    <?php if($title[0]->setting_whatsapp != ''): ?>
                    <li><a href=""><i class="icon-whatsapp mr-2" aria-hidden="true"></i>+91 <?php echo e(@$title[0]->setting_whatsapp); ?></a></li>
                    <?php endif; ?>
                    <?php if($title[0]->setting_contact_email != ''): ?>
                    <li><a href="mailto:<?php echo e(@$title[0]->setting_contact_email); ?>"><i class="icon-envelope mr-2" aria-hidden="true"></i><?php echo e(@$title[0]->setting_contact_email); ?></a></li>
                    <?php endif; ?>
                </ul>
                <?php if($title[0]->setting_facebook != '' || $title[0]->setting_twitter != '' || $title[0]->setting_linkedin != '' || $title[0]->setting_youtube != ''): ?>
                <h1 class="text-left lead mt-2"><b>Follow Us On</b></h1>
                <?php endif; ?>
                <ul class="list-inline">
                    <?php if($title[0]->setting_facebook != ''): ?>
                    <li class="list-inline-item"><a href="<?php echo e($title[0]->setting_facebook); ?>" target="_blank"><i class="icon-facebook" aria-hidden="true"> </i></a></li>
                    <?php endif; ?>
                    <?php if($title[0]->setting_twitter != ''): ?>
                    <li class="list-inline-item"><a href="<?php echo e($title[0]->setting_twitter); ?>" target="_blank"><i class="icon-twitter" aria-hidden="true"> </i></a></li>
                    <?php endif; ?>
                    <?php if($title[0]->setting_linkedin != ''): ?>
                    <li class="list-inline-item"><a href="<?php echo e($title[0]->setting_linkedin); ?>" target="_blank"><i class="icon-linkedin" aria-hidden="true"> </i></a></li>
                    <?php endif; ?>
                    <?php if($title[0]->setting_youtube != ''): ?>
                    <li class="list-inline-item"><a href="<?php echo e($title[0]->setting_youtube); ?>" target="_blank"><i class="icon-youtube" aria-hidden="true"> </i></a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p class="text-center text-white">© <?php echo e($y); ?> <?php echo e($name); ?> All rights reserved. Designed by A2Zproviders</p>
            </div>
        </div>
    </div>
</footer>
...
<div class="sticky-container">
    <ul class="sticky" style="z-index:9999;">
        <li>
            <p><a href="tel:+91<?php echo e($title[0]->setting_mobile); ?>"><i class="icon-phone"></i> Call Us</a></p>
        </li>
        <li>
            <p><i class="icon-whatsapp"></i> WhatsApp</p>
        </li>
        <li>
            <p><a href="mailto:<?php echo e(@$title[0]->setting_contact_email); ?>"><i class="icon-envelope"></i> Mail Us</a></p>
        </li>
    </ul>
</div>
...
</html><?php /**PATH D:\work\asb\web work\sandblast.in\resources\views/frontend/common/footer.blade.php ENDPATH**/ ?>