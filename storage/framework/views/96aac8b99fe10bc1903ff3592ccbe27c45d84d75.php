			          ...
			          <tbody>
			          		...
			          		<?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			               	<tr>
								...
								<td class="icon-cent">
									<a href="<?php echo e(url('service-panel/location/cities/'.$rec->city_id)); ?>" class="pencil"><i class="icon-pencil" title="Edit"></i></a>
								</td>
			               	</tr>
			               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			          </tbody>
...
<?php /**PATH C:\xampp\htdocs\sandblast\resources\views/backend/inc/city.blade.php ENDPATH**/ ?>