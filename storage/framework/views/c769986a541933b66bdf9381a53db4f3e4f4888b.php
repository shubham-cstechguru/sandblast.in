					...
					<div class="content-part">
						<div class="category">
							<div class="form-group">
								...
								<textarea rows="10" name="record[product_specification]" placeholder="Specification" class="form-control editor"><?php echo e(@$edit->product_specification); ?></textarea>
							</div>
						</div>
					</div>
				</div>
...
</section><?php /**PATH D:\work\asb\web work\sandblast.in\resources\views/backend/inc/add_product.blade.php ENDPATH**/ ?>